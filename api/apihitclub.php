...
if (empty($referer)) {
    ...
    echo 'API CỦA BỐ ĐỊT MẸ KHÔNG TRÌNH ĐÒI CRACK BỐ HAHAHAHAH CAYYYYYYY CAYYYYY KHÔNG TRÌNH ĐÒI CRACK CHA HẢ MẤY CON TRAI CAYYYY CAYYYYY CAY HAHAHAH CAYYY LẮM HÁ HÁ';
    exit;
}
...
$api_url = "https://wshitmd5-vu1l.onrender.com/api/sunwin/mrtinhios";
$ch = curl_init();
